...
class BookingController extends Controller
{
     ...
     * @return mixed
     */
    public function update($id, AuthenticatedUserRequest $request)
    {
     ...
     * @return mixed
     */
    public function acceptJob(AuthenticatedUserRequest $request)
    {
     ...
     * @return mixed
     */
    public function cancelJob(AuthenticatedUserRequest $request)
    {
     ...
     * @return mixed
     */
    public function getPotentialJobs(AuthenticatedUserRequest $request)
    {
